...
<script>
    ...
    import dataOptions from "@/modules/history/historyOptions";
    import foreignDataOptions from "@/modules/history/historyOptions";
    ...
    export default {
        ...
        data() {
            return {
                ...
                childPageView: false,
                condition: "",
                queryCondition:{ historyType : '入库'},
                currentDbRow: {},
                url : `/Autumn/v1/private/history/query`,
